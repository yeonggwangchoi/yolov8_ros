...
class Yolov8Detector:
    def __init__(self):
        self.model = YOLO("/home/fc/catkin_ws/src/gm/yolov8_ros/weights/yolov8s.pt")
        self.img_sub = rospy.Subscriber('/usb_cam/image_raw', Image, self.callback)
        self.pred_pub = rospy.Publisher("/yolov8_ros_bbox", BoundingBoxes, queue_size=10)
        self.pred_img_pub = rospy.Publisher('yolov8_ros_img', Image, queue_size=10)
